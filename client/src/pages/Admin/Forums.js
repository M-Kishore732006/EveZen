        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="h-100 d-flex flex-column">
            <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                <div>
                    ...
                    <p className="text-muted mb-0">Supervise and manage all event communications globally.</p>
                </div>
            </div>
                                ...
                                {messages.filter(m => m.category === 'Announcements').length === 0 ? (
                                    ...
                                    messages.filter(m => m.category === 'Announcements').map(m => (
                                        <div key={m._id} className="p-4 rounded-4 position-relative" style={{ backgroundColor: 'rgba(241, 196, 15, 0.05)', border: '1px solid rgba(241, 196, 15, 0.2)' }}>
                                            {true && <Button variant="link" size="sm" className="position-absolute text-muted p-0" style={{ right: '16px', top: '16px' }}>Unpin</Button>}
                                ...
                                {[
                                    ...
                                    <div key={i} className="p-3 bg-light rounded d-flex justify-content-between align-items-center">
                                        ...
                                        <div className="d-flex gap-2">
                                            {true && <Button variant="outline-danger" size="sm" className="rounded-pill px-3 fw-bold border-dashed">Remove</Button>}
                        ...
                        <div className="p-4 bg-white border-top">
                            <Form onSubmit={handleSendMessage}>
                                <InputGroup>
                                    ...
                                    <Form.Control 
                                        placeholder={`Type to post in ${activeTab}...`} 
                                        className="bg-light border-0 shadow-none" 
                                        style={{ borderRadius: (true && activeTab === 'Resources') ? '0' : '24px 0 0 24px', paddingLeft: '20px', height: '48px' }}
