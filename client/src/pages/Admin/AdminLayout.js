...
import { LayoutDashboard, Calendar, MapPin, Users, User, LogOut, Menu, Bell, Search, Moon, Sun, ChevronDown, MessageSquare, UserCircle } from 'lucide-react';
...
const AdminLayout = () => {
    ...
    const navItems = [
        ...
        { path: '/admin/users', icon: UserCircle, label: 'Registered Users' },
