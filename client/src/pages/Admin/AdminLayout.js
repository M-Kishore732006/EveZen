...
import { LayoutDashboard, Calendar, MapPin, Users, LogOut, Menu, Bell, Search, Moon, ChevronDown } from 'lucide-react';
    ...
    return (
        <div style={{ backgroundColor: 'var(--bg-color)', minHeight: '100vh', display: 'flex', overflow: 'hidden' }}>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
                {/* Topbar */}
                <header className="px-5 py-3 d-flex justify-content-between align-items-center bg-white" style={{ borderBottom: '1px solid rgba(0,0,0,0.04)' }}>
                    <div className="d-flex align-items-center gap-4 w-50">
                        ...
                        <div className="position-relative w-100" style={{ maxWidth: '400px' }}>
                            ...
                            <input 
                                ...
                                style={{ paddingLeft: '44px', borderRadius: '20px', backgroundColor: 'var(--bg-color)', border: 'none' }}
                            />
                        </div>
                    </div>
